...
/**
 * @title MATIC Token - DevNet Version
 * @notice ERC20 implementation of MATIC for testing
 */
contract MATIC {
    ...
    constructor() {
        ...
        _mint(msg.sender, 1000000 * 10**decimals); // 1M MATIC
    }
    ...
    function faucet() external {
        ...
        _mint(msg.sender, 1000 * 10**decimals); // 1000 MATIC
    }
}
