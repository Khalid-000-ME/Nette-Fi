...
async function main() {
    ...
    try {
        ...
        console.log("\n📄 Deploying UserContract_Simplified...");
        ...
        console.log("✅ UserContract_Simplified deployed to:", userContractAddress);
        
        // Deploy NettedAMM_Simplified
        console.log("\n📄 Deploying NettedAMM_Simplified...");
        ...
        console.log("✅ NettedAMM_Simplified deployed to:", nettedAMMAddress);
        ...
        console.log("💾 Deployment info saved to deployments/simplified-contracts.json");
